...
@section('content')
  ...
  <main id="main" class="main">
    ...
    <h1>Tambah Akun</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="/account-assessor-add">Home</a></li>
    ...
    <section class="section">
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title center" align="center"><b>Tambah Akun Assesor</b></h5>

              <!-- Vertical Form -->
              <form class="row g-3" action="{{ route('account-assessor-add-data') }}" method="POST">
                @csrf
                    <div class="col-6">
