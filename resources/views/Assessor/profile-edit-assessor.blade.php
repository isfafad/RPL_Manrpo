                  ...
                  <form method="POST" action="{{ route('profile-edit-assessor', $assessor->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                          @if ($assessor->foto) 
                              <img src="{{ asset('public/Data/profile_pict_assesor/' . $assessor->foto) }}" alt="Profile" class="img-fluid"> 
                          @else
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="no_hp" type="text" class="form-control" id="no_hp" value="{{ $assessor->no_hp }}" required>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input type="text" class="form-control" id="alamat" name="alamat" value="{{ $assessor->alamat }}" required>
                      </div>
                    </div>
