      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <!-- Vertical Form -->
            <form class="row g-3" method="POST" action="{{ route('ijazah-add') }}" enctype="multipart/form-data">
                @csrf
                <div class="col-6">
                  <label for="institusi_pendidikan" class="form-label">Nama Perguruan Tinggi/Sekolah</label>
                  <input type="text" class="form-control" id="institusi_pendidikan" name="institusi_pendidikan" value="{{ old('institusi_pendidikan') }}" required>
                </div>
                <div class="col-6">
                ...
                <div class="col-6">
                  ...
                  <input type="text" class="form-control" id="fakultas" name="fakultas" value="{{ old('fakultas') }}" required>
                </div>
                <div class="col-6">
                ...
                <div class="col-6">
                  ...
                  <input type="text" class="form-control" id="ipk_nilai" name="ipk_nilai" value="{{ old('ipk_nilai') }}" required>
                </div>
                <div class="col-6">
