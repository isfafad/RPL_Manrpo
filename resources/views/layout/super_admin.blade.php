...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">Isfa Fadil Muhammad</span>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="/super_admin/dashboard">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#account-user-sidebar" data-bs-toggle="collapse" href="#">
          <i class="bi bi-journal-text"></i><span>Tambah Akun RPL</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        ...
        <a class="nav-link collapsed" data-bs-target="#data-user-sidebar" data-bs-toggle="collapse" href="#">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/kelola-assessor-mahasiswa">
            <i class="bi bi-journal-text"></i><span>Kelola Assessor</span>
          </a>
        </li>
        <li class="nav-item">
