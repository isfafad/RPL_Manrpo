...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
            ...
            <div style="width: 35px; height: 35px; overflow: hidden; position: relative; border-radius: 50%;">
                <img src="{{ $profileInfo['foto_url'] }}" alt="Profile" 
                    style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;">
            </div>
            <span class="d-none d-md-block dropdown-toggle ps-2">{{ $profileInfo['nama'] }}</span>
            </a>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="/view-ijazah">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-journal-text"></i><span>E-Portofolio</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="/self-assessment-table">
              <i class="bi bi-circle"></i><span>Penilaian Diri</span>
            </a>
          </li>
          <li>
            <a href="/view-nilai">
              <i class="bi bi-circle"></i><span>Lihat Nilai</span>
            </a>
          </li>
          <li>
