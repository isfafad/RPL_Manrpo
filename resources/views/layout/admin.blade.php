...
<head>
  ...
  * License: https://bootstrapmade.com/license/
  ...
  <style>
    ...
    .table-admin {
        table-layout: auto;
        width: 100%; /* Atur agar tabel tetap memenuhi lebar halaman */
    }
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6>{{ $profileInfo['nama'] }}</h6>
              <span>{{ $profileInfo['jurusan'] }}</span>
            </li>
            <li>
              <hr class="dropdown-divider">
            </li>
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/kelola-assessor-mahasiswa">
            <i class="bi bi-card-checklist"></i><span>Kelola Assessor</span>
          </a>
        </li>
        <li class="nav-item">
