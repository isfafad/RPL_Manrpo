        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <a href="/account-admin-add"><button type="button" class="btn btn-primary mb-3 float-end" >Tambah</button></a>

              <!-- Dropdown for selecting Jurusan -->
              <form class="row g-3" action="{{ route('account-admin-table') }}" method="GET">
