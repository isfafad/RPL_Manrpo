                ...
                <div class="tab-pane fade show active profile-edit pt-3" id="profile-edit">
                  ...
                  <form method="POST" action="{{ route('profile-edit-admin', $admin->id) }}" enctype="multipart/form-data">
                      ...
                      <div class="col-md-8 col-lg-9">
                          @if ($admin->foto) 
                            <div style="width: 200px; height: 200px; overflow: hidden; position: relative;">
                                <img src="{{ asset('public/Data/profile_pict_admin/' . $admin->foto) }}" alt="Profile"
                                     style="width: 100%; height: 100%; object-fit: cover; position: absolute;">
                            </div>
                          @else
                              <img src="public/assets/img/profile-img.jpg" alt="Profile" style="width: 200px; height: 200px; object-fit: cover;">
                          @endif
                          <div class="pt-2">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="no_hp" type="text" class="form-control" id="no_hp" value="{{ $admin->no_hp ?? '-' }}" required>
                      </div>
                    </div>
